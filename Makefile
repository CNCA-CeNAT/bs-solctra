...
mpi-icpc-knl: $(SOURCE)
	mpiicpc -xMIC-AVX512 -fp-model precise -fp-model source -qopt-report=5 -qopt-report-phase:vec -qopt-report-phase:openmp -O3 -std=c++11 -o solctra.knl   -DKNL=16  -qopenmp -Wall $(SOURCE)
...
mpi-icpc-knl-g: $(SOURCE)
	mpiicpc -g -xMIC-AVX512 -fp-model precise -fp-model source -qopt-report=5 -qopt-report-phase:vec -qopt-report-phase:openmp -O3 -std=c++11 -o solctra.knl.g -DKNL=16  -qopenmp -Wall $(SOURCE)
